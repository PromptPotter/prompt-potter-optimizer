"""Tests for node_role, IntermediateMetric, ROLE_METRIC_REGISTRY, derive_metrics()."""
...
def _make_results(hits, total, *, gt_in_candidates=True):
    """Build results with pipeline_data for metric computation."""
    results = []
...
class TestDeriveMetrics:
    ...
    def test_cache_hit_rate(self):
        ...
        results = _make_results(2, 4)
        # cache_lookup has None timing in our test data
        metrics = schema.derive_metrics(results)
