"""Node-level tracing — async context manager for timing + observability.

Extracted from ``observability_logger.py`` to its own module since it is
standalone (not part of the ObsLogger class).
"""
