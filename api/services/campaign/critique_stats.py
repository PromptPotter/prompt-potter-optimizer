"""Deterministic stat computation and prompt assembly for the critique agent.

All functions are pure (no I/O, no LLM calls). Computes pipeline health,
rank analysis, round evolution, and query categories inline in the prompt.
"""
