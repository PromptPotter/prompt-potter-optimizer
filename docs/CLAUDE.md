...
| [`research/`](research/) | Publication-facing: [benchmarks](research/benchmarks.md) — the origin-screening roster, the admission bar, what we report and the winner's-curse ruling — plus [bbeh-comparison/](research/bbeh-comparison/README.md) (head-to-head harness). | this table |
