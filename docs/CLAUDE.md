...
| [`research/`](research/) | Publication-facing: [benchmarks](research/benchmarks.md) — the origin-screening roster, the admission bar, the four reported metrics and the winner's-curse ruling — plus [bbeh-comparison/](research/bbeh-comparison/README.md) (head-to-head harness). | this table |
