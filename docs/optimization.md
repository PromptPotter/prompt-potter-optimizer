...
campaign_config = {
    ...
    "exclude_steps": ["llm_ranking"],  # target pipeline nodes to skip
    "optimization": {
        "n_variants": 5,
        "creativity": 0.7,
