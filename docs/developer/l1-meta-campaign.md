...
Result JSON: `archive/sweeps/{l1_hash}/{dataset}/{verb}_..._{ts}.json`. Spec: [`roadmap.md#track-6--sweep-toolkit`](../specs/roadmap.md#track-6--sweep-toolkit). Skill reads these for Phase 4 verdicts + Phase 6 correlation.
