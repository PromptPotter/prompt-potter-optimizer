...
- `INJECTIONS`: `promptpotter/application/optimization/dispatch/hub/injections/registry.py`; `InjectionBundle`: `dispatch/hub/bundle.py`; `DispatchHub`: `dispatch/hub/facade.py`; `build_bundle`: `dispatch/hub/builder.py`
