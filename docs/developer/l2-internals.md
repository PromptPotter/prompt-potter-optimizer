...
| `l2_brief` | `_section_l2_brief(ctx)` | Previous round's brief |
...
cycle.opt_sp.l2_brief = result.l2_brief
...
- OSP mutation surface: `promptpotter/domain/opt_search_point.py` — `l2_brief`, `optimizer_params`, `task_context`, `l1_section_overrides`, `l1_section_overrides_text`, `l1_template_override`
