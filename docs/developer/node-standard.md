...
Both backends and the optimizer loop declare pipelines as JSON. Optimizer's at `promptpotter/assets/optimizer/pipeline.yaml`; backend's served by `GET /pipeline`.
