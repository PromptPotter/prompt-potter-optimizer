...
- **[Hard-sample leaderboard](../methods/verdict-resolution.md).** Samples everyone aces or everyone fails carry no signal. The optimizer surfaces and scores on the samples that actually separate candidates.
