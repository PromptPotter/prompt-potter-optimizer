...
**Why:** L1 proposed a parameter value outside the allowed set for a pipeline node. PromptPotter catches this before any backend call (the *schema-compliance check*; Loop 1 in [self-healing](../concepts/self-healing.md)).
