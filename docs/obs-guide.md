# Observability Data Exploration Guide

This guide covers how to navigate the accumulated research data that PromptPotter writes to `obs/` during optimization campaigns.
