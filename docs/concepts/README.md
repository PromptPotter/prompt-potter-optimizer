...
| [Search memory](search-memory.md) | How knowledge accumulates across campaigns; parameter impact, query patterns, failure modes |
| [Prompts and candidates](prompts-and-candidates.md) | The 8-field prompt decomposition |
