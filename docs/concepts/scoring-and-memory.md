...
`AxisIndex.digest()` summarises these three layers into a flat dict; consumers (zero-signal filter, scoring-set evolution, ranking heuristics) read it directly.
