...
- **Prompt exposure.** An LLM node exposes its prompt so PromptPotter can read, display, and optimize it. The prompt is broken into named fields — see [prompts-and-candidates.md](prompts-and-candidates.md) for the decomposition.
