...
Hand-tuning the optimizer's own meta-prompts, and measuring whether an edit helped: [`../manual/06-going-deeper.md`](../manual/06-going-deeper.md) § Iterating on prompts manually.
