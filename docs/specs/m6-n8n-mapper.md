...
|-----------|--------|----------|
| **`io_schema`** | JSON Schemas from `outputParserStructured` nodes | Surface in MappingReport as `SchemaExtension` with `category="io_schema"`. Do NOT add to PipelineStep — cross-cutting M6/M7 decision. |
