...
| [l4-outer-loop.md](l4-outer-loop.md) | **The living finish-line plan for L4 — read § Finish line first; it is the single owner of L4 status**, including whether the outer panel can resolve arms at all. Also the specialized outer optimizer prompt set and the enriched outer composite fitness. |
