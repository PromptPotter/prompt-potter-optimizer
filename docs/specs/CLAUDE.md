...
| M7: Optimizer-as-Pipeline | Complete. [`m7-optimizer-pipeline.md`](m7-optimizer-pipeline.md) | Read `api/services/campaign/feedback_cycle.py`, `api/services/obs/step_tracer.py`, `api/config/optimizer_pipeline.json`, `api/models/opt_search_point.py` |
