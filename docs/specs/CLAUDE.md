...
| [![m10-prompt-iteration-framework](https://img.shields.io/badge/m10--prompt--iteration--framework-black?style=for-the-badge)](m10-prompt-iteration-framework.md) — sub: [`m10-l2-self-diagnosis-and-imagination.md`](m10-l2-self-diagnosis-and-imagination.md) | `promptpotter/application/optimization/{optimizer_pipeline.json,pipeline.py,runner.py}`, `tests/test_invariants.py` |
