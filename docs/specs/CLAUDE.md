...
- [ ] **L3 fork authority → AlphaZero-shaped MCTS.** L3 gains fork-from-ancestor authority + stat backpropagation up the lineage tree + UCB-style ancestor selection. Closes the three structural gaps between today's *best-arm-ID over a one-armed tree* and AlphaZero-shaped MCTS. Unlocks recovery from dead-end branches. → [`roadmap.md#backlog-unscheduled`](roadmap.md#backlog-unscheduled), comparison [`../research/related-work.md#comparison-to-mcts`](../research/related-work.md#comparison-to-mcts)
