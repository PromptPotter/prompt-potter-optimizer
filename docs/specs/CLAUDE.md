...
| M9 (backbone, in progress): Stable Config, Hierarchy Refactor, Multi-Dataset/Pipeline, File-Directory UI v0 | [`m9-stable-config-and-scaffolding.md`](m9-stable-config-and-scaffolding.md) | `promptpotter/application/optimization/prompts/`, `promptpotter/application/` (full tree), `promptpotter/domain/scoring.py`, `notebooks/optimization_campaign.ipynb`, `promptpotter/presentation/ui/campaign/` |
