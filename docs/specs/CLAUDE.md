...
| M6: PipelineSchema + Pipeline Composability | Waves 0-3 complete, Wave 4 → M8. [`m6-pipeline-composability.md`](m6-pipeline-composability.md) | Waves 5-6 (active): read `api/services/prompt_eval.py` (compute_accuracy) and `api/models/pipeline_schema.py` |
