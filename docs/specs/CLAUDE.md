...
| M7: Optimizer-as-Pipeline | Waves A-E complete, Wave F active. [`m7-optimizer-pipeline.md`](m7-optimizer-pipeline.md) | Read `api/services/campaign/feedback_cycle.py`, `api/nodes/optimizer_nodes.py`, `api/models/opt_search_point.py` |
