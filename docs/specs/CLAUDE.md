...
|-----------|-----------|-----------------|
| M8: Campaign Intelligence | [`m8-campaign-intelligence.md`](m8-campaign-intelligence.md) | `api/services/prompt_eval.py`, `api/services/search/smart_search.py`, `api/services/l1_optimizer.py` |
| M9: Multi-Connector | [`m9-multi-connector.md`](m9-multi-connector.md) | `api/services/backend_client.py` |
