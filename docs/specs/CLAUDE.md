...
Archived in git history: M0-M7, M8 (campaign intelligence), old M9 (publication/config/webapp combined). Still on disk: old M9 (multi-connector) at [`archive/m9-multi-connector.md`](archive/m9-multi-connector.md) — kept because M11 still references it.
