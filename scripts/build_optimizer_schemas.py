"""Regenerate ``promptpotter/assets/optimizer/resolved_schemas.json`` from
...
from promptpotter.config.paths import optimizer_assets_root


def main() -> int:
    out_path = optimizer_assets_root() / "resolved_schemas.json"
