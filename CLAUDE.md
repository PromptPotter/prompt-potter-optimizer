...
| **L4 / `promptpotter-self`** self-improvement, the optimizer's own business logic, prompts and configurations alike. | [`l4-outer-loop.md`](docs/specs/l4-outer-loop.md) § Finish line + § Running & supervising · `/potter-self` · [`optimization/CLAUDE.md`](promptpotter/application/optimization/CLAUDE.md) · [`dispatch-hub.md`](docs/developer/dispatch-hub.md) | A leader believed from a panel that cannot resolve arms. |
...
- Full style + code-shape + git rules, and the four banned words → [`docs/developer/conventions.md`](docs/developer/conventions.md); words that name more than one live thing → [`docs/developer/concept-map.md`](docs/developer/concept-map.md) § Bare words.
...
- **Contracts:** ADRs [`0001`](docs/adr/0001-m12-control-plane.md) (control plane) · [`0002`](docs/adr/0002-identity-foundation.md) (identity) · [`0003`](docs/adr/0003-spend-and-tenancy.md) (spend/tenancy) · [`0006`](docs/adr/0006-embeddable-core-and-extras.md) (core is the engine; surfaces are extras). Index map: [`docs/CLAUDE.md`](docs/CLAUDE.md).
