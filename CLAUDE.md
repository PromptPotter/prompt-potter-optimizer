...
|---|---|---|
| Three I/O kinds (Persistence / Display / Control) | per this file | Persistence has one ingress (`CycleLedger.append`); display-side `RunCallbacks` writes nothing; control-side `stop_check` writes no campaign artifacts |
