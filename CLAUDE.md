...
.promptpotter/
  ...
  projects/{tenant_id}/
    ...
    campaigns/{root_cycle_id}/                     # FAMILY ROOT
      dashboard.json                               # telemetry — wire format for /ui webapp; root only (shared across forks)
