...
See `datasets/bbeh/task_description.md` for the trap description and `promptpotter/application/optimization/diagnostics.py:97-121` for the `classify_result()` rule table.
