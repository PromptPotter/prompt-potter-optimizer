  ...
  return (
    <div className="hs-footer">
      ...
      <label
        ...
        title={
          syncLive
            ? "Sort follows the queue mechanism's Info-gain ranking. Order only refreshes when the artifact regenerates (round boundary) — not on every 2 s poll, so the table doesn't flash. Untick to sort columns manually."
            : "Sort with column headers. Tick to follow the queue mechanism's Info-gain ranking — order refreshes once per round, not per poll."
        }
      >
