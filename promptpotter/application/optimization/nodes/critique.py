...
``CritiqueAgent`` wraps the critique LLM call. Pure stat-section helpers
(``_*_section``, ``_assemble_critique_sections``) build the prompt body.
"""
...
# ---------------------------------------------------------------------------
# Critique prompt body — pure stat-section builders
# ---------------------------------------------------------------------------
