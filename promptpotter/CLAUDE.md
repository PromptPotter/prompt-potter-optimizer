...
- **Layer-import invariant** (enforced by `tests/test_structure.py::test_runtime_layer_imports`): `application/intelligence/` MUST NOT import from `application/optimization/`.
