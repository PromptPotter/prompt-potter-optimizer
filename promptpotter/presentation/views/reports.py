"""Terminal completion banner — closing summary box for finished runs.

The post-hoc markdown digest (``render_log_md``) and its hard-sample
heatmap moved to ``application.campaign.log_md`` so the campaign runner
can render them without crossing into ``presentation/``.
"""
